            ...
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="lg:w-3/5">
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">プロフィール</h2>
                ...
                >
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">キャリア経歴</h3>
                ...
                >
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-6">スキルと専門知識</h3>
