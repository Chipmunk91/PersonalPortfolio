...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-white dark:bg-primary-600 text-gray-900 dark:text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/contact" onClick={() => window.scrollTo(0, 0)}>
            <Button className="bg-primary-600 text-white hover:bg-primary-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 transition-colors border border-transparent dark:border-gray-700">
              Get in touch
            </Button>
          </Link>
        </div>
