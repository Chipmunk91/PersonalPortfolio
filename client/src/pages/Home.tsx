...
import { ArrowRight, ArrowUpRight, Code, Brain, PaintBucket } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center mb-10">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Specialized in</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Interactive Visualizations</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Building dynamic, responsive visual interfaces that let users explore complex data intuitively.
              </p>
              <div className="flex space-x-2">
                <FaReact className="text-blue-500" />
                <FaJs className="text-yellow-500" />
                <span className="text-sm text-gray-500 dark:text-gray-400">D3.js, Three.js</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">AI Model Interpretability</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Making complex AI/ML models transparent and understandable through visual and interactive tools.
              </p>
              <div className="flex space-x-2">
                <FaPython className="text-blue-500" />
                <span className="text-sm text-gray-500 dark:text-gray-400">TensorFlow, PyTorch</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">UX/UI Design</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Creating intuitive, accessible interfaces that make complex data visualizations easy to understand.
              </p>
              <div className="flex space-x-2">
                <span className="text-sm text-gray-500 dark:text-gray-400">Figma, Framer, Motion Design</span>
              </div>
            </motion.div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gray-100 dark:bg-primary-600 border-t border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">Ready to transform your data into intuitive visuals?</h2>
          ...
          <Link href="/contact" onClick={() => window.scrollTo(0, 0)}>
            <Button className="bg-primary-600 text-white hover:bg-primary-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 transition-colors border border-transparent">
              Get in touch
            </Button>
          </Link>
        </div>
