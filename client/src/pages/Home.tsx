...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-white dark:bg-primary-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-primary-100 mb-8 max-w-2xl mx-auto">
            Let's collaborate on your next project and create powerful, interactive visualizations that drive insights.
          </p>
          <Link href="/contact" onClick={() => window.scrollTo(0, 0)}>
            <Button className="bg-primary-600 text-white hover:bg-primary-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 transition-colors">
              Get in touch
            </Button>
          </Link>
        </div>
