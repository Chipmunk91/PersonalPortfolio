...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-b from-indigo-700 to-indigo-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/contact" onClick={() => window.scrollTo(0, 0)}>
            <Button className="bg-white text-indigo-700 hover:bg-gray-100 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 transition-colors">
              Get in touch
            </Button>
          </Link>
        </div>
