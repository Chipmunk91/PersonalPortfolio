...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-primary-600 to-primary-500 dark:from-primary-700 dark:to-primary-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl font-bold mb-4 text-white">Ready to transform your data into intuitive visuals?</h2>
          ...
          <Link href="/contact" onClick={() => window.scrollTo(0, 0)}>
            <Button className="bg-white text-primary-600 hover:bg-gray-100 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 transition-colors border border-primary-400">
              Get in touch
            </Button>
          </Link>
        </div>
