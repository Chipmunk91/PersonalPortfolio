      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="p-6 md:p-8">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Interactive Playground</h3>
            ...
            <div className="mt-6 flex justify-center">
              <a href="#" className="text-primary-500 hover:text-primary-600 font-medium flex items-center gap-1 transition-colors">
                <span>Explore more interactive examples</span>
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
