        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Sheet>
              ...
              <SheetContent>
                <div className="flex flex-col space-y-4 mt-8">
                  ...
                  <Link href="/contact" onClick={() => window.scrollTo(0, 0)} className="px-3 py-2 text-base font-medium bg-primary-500 text-white hover:bg-primary-600 outline outline-1 outline-primary-600 rounded-md shadow-sm">Contact Me</Link>
                </div>
              </SheetContent>
            </Sheet>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/contact" onClick={() => window.scrollTo(0, 0)} className="px-4 py-2 rounded-md bg-primary-500 text-white hover:bg-primary-600 outline outline-1 outline-primary-600 transition-colors shadow-sm">Contact Me</Link>
            </div>
          </div>
        </div>
      </div>
